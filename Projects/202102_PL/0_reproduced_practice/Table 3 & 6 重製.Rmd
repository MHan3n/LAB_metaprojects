...
A1 <- anova(m00, m1) # Random Intercept Participant 
dplyr::select(A1,Chisq)
#Random Slopes
...
A2 <- anova(m2a, m1) # Random Slope OSA by Participant 	

A3 <- anova(m2b, m1) # Random Slope No Subheadings by Participant 	
...
A4 <- anova(m2a,m3a) # Justification Beliefs on Random Intercept 	

A5 <- anova(m2a,m3b) # Justification Beliefs on Random Slope OSA 	

m3a <- lmer(vst ~(1 | study) + NH+ OSA + Englisch +   (OSA | id), data = df)
m3b <- lmer(vst ~(1 | study) + NH+ OSA * Englisch +   (OSA | id), data = df)

A6 <- anova(m2a,m3a) # English Proficiency on Random Intercept 	

A7 <- anova(m3a,m3b) # English Proficiency on Random Slope OSA 	
...
B5 <- anova(m00, m) #Random Intercept Participant 	
