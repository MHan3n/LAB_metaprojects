...
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] %>%
  ...
  value = "score1", 
  "Chisq":"Pr(>Chisq)")           # Random Intercept Participant 
...
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]%>%  
  ...
  key = "Comprehensibility", 
  value = "score2", 
  "Chisq":"Pr(>Chisq)")# Random Slope OSA by Participant 
...
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] %>% 
  ...
  key = "Comprehensibility", 
  value = "score3", 
  "Chisq":"Pr(>Chisq)")# Random Slope No Subheadings by Participant 	
...
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]%>%
  ...
  key = "Comprehensibility", 
  value = "score5", 
  "Chisq":"Pr(>Chisq)")# Justification Beliefs on Random Slope OSA 	
...
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]%>%
  ...
  key = "Comprehensibility", 
  value = "score6", 
  "Chisq":"Pr(>Chisq)")# English Proficiency on Random Intercept 	
...
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] %>%
  ...
  key = "Comprehensibility", 
  value = "score7", 
  "Chisq":"Pr(>Chisq)")# English Proficiency on Random Slope OSA 	

Comprehensibility_ratio_tests <- list(Vst_1,Vst_2,Vst_3,Vst_4,Vst_5,Vst_6,Vst_7) %>% reduce(left_join, by = "Comprehensibility") 
